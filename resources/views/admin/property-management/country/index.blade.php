...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('admin.property_management.countries') }}" method="get"
                                id="carSearchForm">
                                <div class="row">
                        ...
                        <div class="col-lg-3 mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('admin.property_management.bulk_delete_country') }}">
                        ...
                        <div class="col-lg-12">
                            ...
                            @else
                                <div class="table-responsive">
                                    <table class="table table-striped mt-3" id="basic-datatableds">
                                        <thead>
                                            <tr>
                                                <th scope="col">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('admin.property_management.delete_country') }}"
                                                            method="post">
                                                            @csrf
    ...
    {{-- create modal --}}
    @include('admin.property-management.country.create')

    {{-- edit modal --}}
    @include('admin.property-management.country.edit')
@endsection
