...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card-title d-inline-block">{{ __('Areas') }}</div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('admin.property_management.cities') }}" method="get" id="carSearchForm">
                                <div class="row">


                                    <input type="text" name="name" value="{{ request()->input('name') }}"
                                        class="form-control" placeholder="{{ __('Search by area name') }}">
                        ...
                        <div class="col-lg-3 mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('admin.property_management.bulk_delete_city') }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (count($cities) == 0)
                                <h3 class="text-center mt-2">{{ __('NO AREAS FOUND') }}
                                </h3>
                            @else
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form id="featureForm{{ $city->id }}"
                                                                ...
                                                                action="{{ route('admin.property_management.update_city_featured') }}"
                                                                method="POST">
                                                                @csrf
                                                    ...
                                                    <td>
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('admin.property_management.delete_city') }}"
                                                            method="post">
                                                            @csrf
                        ...
                        <div class="col-12">
                            {{ $cities->appends(['name' => request()->input('name'), 'language' => request()->input('language')])->links() }}
                        </div>
                    </div>
                </div>
    ...
    {{-- create modal --}}
    @include('admin.property-management.city.create')

    {{-- edit modal --}}
    @include('admin.property-management.city.edit')
@endsection
@section('scripts')
    <script>
        let stateUrl = "{{ route('admin.property_management.get_state') }}";
    </script>
