...
@section('content')
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('admin.property_management.categories') }}" method="get"
                                id="carSearchForm">
                                <div class="row">


                                    <input type="text" name="name" value="{{ request()->input('name') }}"
                                        class="form-control" placeholder="{{ __('Search by category name') }}">
                        ...
                        <div class="col-lg-3  mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('admin.property_management.bulk_delete_category') }}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="featureForm{{ $category->id }}" class="d-inline-block"
                                                            action="{{ route('admin.property_management.update_category_featured') }}"
                                                            method="post">
                                                            @csrf
        ...
        @php
            $catContent = $category->getContent($lang->id);
        @endphp
        data-{{ $lang->code }}_name="{{ $catContent?->name }}" @endforeach
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('admin.property_management.delete_category') }}"
                                                            method="post">
                                                            @csrf
                        ...
                        <div class="col-12">
                            {{ $categories->appends(['name' => request()->input('name'), 'language' => request()->input('language')])->links() }}
                        </div>
                    </div>
                </div>
            </div>
    ...
    {{-- create modal --}}
    @include('admin.property-management.category.create')

    {{-- edit modal --}}
    @include('admin.property-management.category.edit')
@endsection
