...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('admin.property_management.amenities') }}" method="get"
                                id="carSearchForm">
                                <div class="row">
                        ...
                        <div class="col-lg-3 mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('admin.property_management.bulk_delete_amenity') }}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('admin.property_management.delete_amenity') }}"
                                                            method="post">
                                                            @csrf
    ...
    {{-- create modal --}}
    @include('admin.property-management.amenity.create')

    {{-- edit modal --}}
    @include('admin.property-management.amenity.edit')
@endsection
