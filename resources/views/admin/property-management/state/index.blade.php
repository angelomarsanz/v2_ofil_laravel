...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <form action="{{ route('admin.property_management.states') }}" method="get"
                                id="carSearchForm">
                                <div class="row">
                        ...
                        <div class="col-lg-3 mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('admin.property_management.bulk_delete_state') }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (count($states) == 0)
                                <h3 class="text-center mt-2">{{ __('NO CITIES FOUND') }}
                                </h3>
                            @else
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('admin.property_management.delete_state') }}"
                                                            method="post">
                                                            @csrf
    ...
    {{-- create modal --}}
    @include('admin.property-management.state.create')

    {{-- edit modal --}}
    @include('admin.property-management.state.edit')
@endsection
