            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ticket_no" type="text" class="form-control"
                                                placeholder="{{ __('Search by ticket number') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ticket_status"
                                                ...
                                                <option value="pending"
                                                    {{ request()->input('ticket_status') == 1 ? 'selected' : '' }}>
                                                    {{ __('Pending') }}
                                                </option>
                                                <option value="open"
                                                    {{ request()->input('ticket_status') == 2 ? 'selected' : '' }}>
                                                    {{ __('Open') }}
                                                </option>
                                                <option value="closed"
                                                    {{ request()->input('ticket_status') == 3 ? 'selected' : '' }}>
                                                    {{ __('Closed') }}
                                                </option>
                                            </select>
                                        </div>
                        ...
                        <div class="col-lg-3">
                            <button class=" mt-4 btn btn-danger btn-sm d-none bulk-delete float-lg-right card-header-button"
                                        ...
                                        <tbody>
                                            @foreach ($tickets as $ticket)
                                                <tr>
                                                    ...
                                                    @php $customer = $ticket->user; @endphp
