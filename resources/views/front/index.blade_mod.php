...
@section('content')
    ...
    @if (count($after_work_process) > 0)
        ...
        @endforeach
    @endif
    <section id="promo-video" class="promo-section bg-img bg-cover border-top" 
    data-bg-image="{{ asset('assets/front/images/hero-bg.png') }}">
    <div class="container-fluid">
        <div class="row align-items-center gx-xl-5">

            <!-- Columna Izquierda: Texto + Botón Video -->
            <div class="col-xl-6">
                <div class="content" data-aos="fade-right" data-aos-delay="100">
                    <h2 class="title">Descubre Nuestro CRM</h2>
                    <p>Optimiza tu gestión con nuestra plataforma, diseñada para que tengas todo el control en un solo lugar.</p>

                    <div class="video-btn-wrapper" data-aos="fade-up" data-aos-delay="200">
                        <!-- Botón que abre el video de YouTube -->
            ...
            <div class="col-xl-6">
                <div class="image-stack" data-aos="fade-left" data-aos-delay="200">
                    <img src="{{ asset('assets/front/images/hero-img.png') }}" alt="Pantalla 1" class="stack-img img1">
                    <img src="{{ asset('assets/front/images/hero-img.png') }}" alt="Pantalla 2" class="stack-img img2">
                    <img src="{{ asset('assets/front/images/hero-img.png') }}" alt="Pantalla 3" class="stack-img img3">
                </div>
            </div>
        </div>
    </div>
...
<!-- Script para abrir video de YouTube en lightbox -->
<script>
