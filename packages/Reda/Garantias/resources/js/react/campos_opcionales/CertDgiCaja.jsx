...
export const CertDgiCaja = ({control, contadorArchivos, actualizarMensajeError}) => {
  ...
  return (
      <>
        <label htmlFor="cert_dgi_caja">{t("Certificados vigentes de BPS y DGI *")}</label>
        <br />
        <Button
            component="label"
            role={undefined}
