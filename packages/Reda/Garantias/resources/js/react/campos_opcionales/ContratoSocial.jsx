...
export const ContratoSocial = ({control, contadorArchivos, actualizarMensajeError, etiqueta, etiqueta2}) => {
  ...
  return (
      <>
        <label htmlFor="contrato_social">{etiqueta}</label>
        <br />
        <Button
            component="label"
            role={undefined}
