...
export const CertIngMod = ({ control, contadorArchivos, actualizarMensajeError, etiqueta, etiqueta2 }) => {
  ...
  return (
    <>
      <label htmlFor="cert_ing_mod">{etiqueta}</label>
      <br />
      <Button
        component="label"
        role={undefined}
