  ...
  return (
    <div>
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        <AccordionDetails>
          <ul>
            ...
            <li><Typography>Últimos 3 recibos de sueldo (sueldo fijo) o último recibo (sueldo variable).</Typography></li>
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        ...
        <AccordionDetails>
          <ul>
            <li><Typography>Últimos 3 recibos de cobro emitido por la caja oficial correspondiente.</Typography></li>
            <li><Typography>Foto de cédula vigente.</Typography></li>
            <li><Typography>Dirección de e-mail.</Typography></li>
          </ul>
          <Typography sx={{fontWeight : 600}}><img alt="Aviso" src="https://s.w.org/images/core/emoji/14.0.0/svg/26a0.svg" style={{width : 10, marginRight : '0.5rem'}}/>Importante: No estar en el Clearing</Typography>
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        ...
        <AccordionDetails>
          <ul>
            ...
            <li><Typography>Certificado de estar al día con la Caja Notarial o CJPPU o Profesional según corresponda.</Typography></li>
      ...
      <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
        <AccordionSummary aria-controls="panel4d-content" id="panel4d-header">
          <Typography>Socios o accionistas de sociedades comerciales</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <ul>
            <li><Typography><strong style={{fontWeight : 600}}>Antigüedad comercial mínima: 24 meses.</strong></Typography></li>
            <li><Typography>Informe de ingresos por contador público.</Typography></li>
            <li><Typography>Dos últimos balances contables auditados, certificados o con revisión limitada.</Typography></li>
