import AcordionMuiPorto from "./AcordionMuiPorto.jsx";
import { BsCheckLg, BsXLg } from "react-icons/bs";
import Grid from '@mui/material/Grid2';

const InformacionPorto = () => {
  return (
    <>
      <br />
      <Grid container>
        <Grid key={'1'} display="flex" justifyContent="center" size={{ xs : 12, sm : 12, md : 6, lg : 6, xl : 6 }}>
          <div className="ra_informacion ra_package">
            <div className="ra_p2"><div className="ra_big">PORTO</div></div>
            <h2>Beneficios</h2>
            ...
            <ul className="ra_ul">
              ...
              <li key="6" className="ra_li"><span className='ra_icono'><BsCheckLg /></span>Hasta 4 personas pueden sumar sus ingresos para una misma garantía de alquiler. Para universitarios solo se permiten 3 personas</li>
            </ul>
...
export default InformacionPorto;