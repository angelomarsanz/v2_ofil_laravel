...
import { opcionesInputs } from "../vectores_objetos";
import {
  Container,
  Paper,
  Stack,
  ...
  return (
    <>
      <Box component={Paper} elevation={12} sx={{ marginTop : '14rem', p : 2, borderRadius : 3 }}>
        <DatosGarantia idGarantia={idGarantia} origen={'DetalleGarantia'} tituloVista={t('texto_181')} />
        {gifEspere}
        {alertaFija} 
        <br /><br /><br />
      </Box>
