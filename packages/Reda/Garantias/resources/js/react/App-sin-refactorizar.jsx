            ...
            <AppProvider>
              <Router>
                <Routes>
                  ...
                  <Route path="/user/garantias/seleccionar-aseguradora/:idGarantia" element={<SeleccionarAseguradora />} />
                  <Route path="/admin/garantias/seleccionar-aseguradora/:idGarantia" element={<SeleccionarAseguradora />} />
                  <Route path="/:agencia/garantias/agent/seleccionar-aseguradora/:idGarantia" element={<SeleccionarAseguradora />} />

                  <Route path="/user/garantias/datos-propiedad/:idGarantia" element={<DatosPropiedad />} />
                  <Route path="/admin/garantias/datos-propiedad/:idGarantia" element={<DatosPropiedad />} />
                  <Route path="/:agencia/garantias/agent/datos-propiedad/:idGarantia" element={<DatosPropiedad />} />
