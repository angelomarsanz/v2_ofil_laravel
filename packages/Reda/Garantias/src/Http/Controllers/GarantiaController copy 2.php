...
class GarantiaController extends Controller
{
    ...
    public function busquedaGarantias(Request $request)
    {
        ...
        // Construir $userNombres: base con nombres de agencias y agregar agentes estate_agent validados
        $userNombres = $agenciaNombres->copy();
        foreach ($garantiasParaFiltros as $g) {
            if ($g->agente_id && $g->tipo_agente === 'estate_agent') {
                ...
                if ($ua && $ua->user_id == $g->agencia_id) {
                    ...
                    if ($nombre) {
                        ...
                        $userNombres->put($g->agente_id, $nombre);
                    }
                }
            }
        }
