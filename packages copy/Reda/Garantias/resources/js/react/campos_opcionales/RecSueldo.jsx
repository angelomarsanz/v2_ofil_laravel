...
export const RecSueldo = ({control, contadorArchivos, actualizarMensajeError, sueldoSeleccionado}) => {
  ...
  return (
      <>
        <label htmlFor="rec_sueldo">{sueldoSeleccionado}</label>
        <br />
        <Button
            component="label"
            role={undefined}
