...
export const ContratoPorto = ({ datosContrato }) => {
  ...
  const clausulaAdicional = generarClausulaAdicional(datosContrato.terminos_condiciones, 23);
  ...
  return (
      <>
        ...
        <p>SEGUNDO: El destino del arriendo es de casa habitación para el (los) arrendatario(s) y su núcleo familiar directo. Dicho destino no podrá cambiarse sin previa autorización por escrito del (los) arrendador(es) y de Porto Seguro - Seguros del Uruguay S.A.</p> 
